            ...
            <div className="relative flex size-full items-center">
              <div className="absolute right-1.5 top-1/2 z-[3] translate-y-[-50%] overflow-hidden">
                {!tab.affixTab && tabView.length > 1 && tab.closable && (
                  <X className="hover:bg-accent stroke-accent-foreground/80 hover:stroke-accent-foreground dark:group-[.is-active]:text-accent-foreground group-[.is-active]:text-primary size-3 cursor-pointer rounded-full transition-all"></X>
                )}
                {tab.affixTab && tabView.length > 1 && tab.closable && (
                  <Pin className="hover:bg-accent hover:stroke-accent-foreground group-[.is-active]:text-primary dark:group-[.is-active]:text-accent-foreground mt-[1px] size-3.5 cursor-pointer rounded-full transition-all"></Pin>
                )}
              </div>
